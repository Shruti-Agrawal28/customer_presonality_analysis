...
class DataValidationConfig:
    ...
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.base_file_path = os.path.join("marketing_campaign.csv")
...
class DataTransformationConfig:
    ...
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.train_file_path = os.path.join(self.data_transformation_dir, "dataset", TRAIN_FILE_NAME)
        self.test_file_path = os.path.join(self.data_transformation_dir, "dataset", TEST_FILE_NAME)
        self.test_size = 0.2
